...
var player = {
  ...
  bindEvents: function bindEvents() {
    for (var key in player.table) {
      if (player.table.hasOwnProperty(key)) {
        //这里检查如果key是player的table里面的自身的属性，而不是其他的属性（后来添加的）
        var value = player.table[key];
  ...
  run: function run() {
    if (player.i > _string.default.length) {
      window.clearInterval(player.id);
      return;
    }

    player.newString = _string.default.substr(0, player.i);
    player.i += 1;
...
player.init();
},{"./string.js":"string.js"}],"../../../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
